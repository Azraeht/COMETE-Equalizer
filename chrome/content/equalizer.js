// Make a namespace.
if (typeof nighingalecometeequalizer == 'undefined') {
  var nighingalecometeequalizer = {};
}

nighingalecometeequalizer = {
	...
	var anim = window.setInterval(
		function()
		{
			...
			for(i = 0; i < 10; i++)
			{
				...
				pref.setCharPref("nightingale.eq.band." + i.toString(),nighingalecometeequalizer.easeInOut(start[i],bands[i],steps,currStep,1.6));
			}
...
window.addEventListener("load", function(e) { nighingalecometeequalizer.onLoad(e); }, false);			
